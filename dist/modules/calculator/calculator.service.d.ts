...
export declare class CalculatorService {
    ...
    calculateRRA(mesesDeIsencaoIdoso: number, { rendimentoTotal, numeroMeses, ano, mes, }: Omit<CalculatorRRADto, "selicStartDate" | "selicEndDate" | "userBirthDate" | "deducoes" | "impostoRetido">): {
        totalRRA: number;
    };
