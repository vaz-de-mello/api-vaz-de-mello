...
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: "O campo `Imposto Retido` é obrigatório." }),
    (0, class_validator_1.IsInt)({ message: "O campo `Imposto Retido` deve ser um número inteiro." }),
    __metadata("design:type", Number)
...
//# sourceMappingURL=rra.dto.js.map