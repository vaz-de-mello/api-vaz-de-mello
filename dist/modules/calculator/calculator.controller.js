...
let CalculatorController = class CalculatorController {
    ...
    async calculateRRA(body) {
        const { numeroMeses, rendimentoTotal, deducoes, ano, mes, selicEndDate, selicStartDate, userBirthDate, impostoRetido, } = body;
        ...
        console.log({ mesesDeIsencaoIdoso });
