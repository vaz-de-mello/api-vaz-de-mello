...
exports.RestitutionService = void 0;
const common_1 = require("@nestjs/common");
const library_1 = require("@prisma/client/runtime/library");
const database_service_1 = require("../database/database.service");
let RestitutionService = class RestitutionService {
    constructor(db) {
        this.db = db;
    }
    ...
    async findAll(query, page) {
        return this.db.$transaction([
            ...
            this.db.restituicao.findMany(Object.assign(Object.assign({ where: query }, page), { orderBy: { createdAt: 'desc' } }))
        ]);
    }
...
RestitutionService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [database_service_1.DatabaseService])
], RestitutionService);
exports.RestitutionService = RestitutionService;
//# sourceMappingURL=restituition.service.js.map